...
// workspace that reflects background Drive activity. Purely presentational.
//   • amber, pulsing → a write/refresh is in flight (Saving / Syncing)
//   • green, steady  → everything written and up to date (Synced)
...
export default function SyncDock({ saving, syncing, refreshing }: Props) {
  ...
  return (
    <div style={dock} title={busy ? 'Drive sync in progress' : 'All changes saved to Drive'}>
      <span
